...
export const userService = {
  ...
  async getUsersPaged(token: string, page: number, pageSize: number): Promise<{ users: User[]; total: number }> {
  ...
  async getUsersByOData(token: string, query: string): Promise<{ users: User[]; total: number }> {
